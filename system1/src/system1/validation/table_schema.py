...
TABLE_SCHEMA_SPECS: tuple[TableSchemaSpec, ...] = (
    ...
    TableSchemaSpec(
        ...
        unique_keys=((column("asr_word_id"),),),
        numeric_columns=(column("start_sec"), column("end_sec"), column("confidence")),
        integer_columns=(column("word_index"), column("start_frame"), column("end_frame")),
        text_columns=(
            column("asr_word_id"),
            column("asr_segment_id"),
            column("video_id"),
        ...
        value_columns=(
            ValueRequirement("alignment_method", ("ctc_forced_alignment", "provider_word_timestamps")),
            ValueRequirement("alignment_version", ("ctc_word_alignment_v1",)),
            ValueRequirement("provider", ("faster_whisper", "nemo")),
            ValueRequirement("status", ("pass",)),
        ),
    ),
    TableSchemaSpec(
        ...
        True,
        (
            column("shot_id"), column("asr_segment_id"), column("video_id"),
            column("overlap_start_sec"), column("overlap_end_sec"),
            column("overlap_sec"), column("segment_coverage"),
            column("entity_coverage"), column("coverage"),
            column("assigned_word_count"),
        ),
        non_null_columns=(
            column("shot_id"),
            column("asr_segment_id"),
            column("video_id"),
            column("overlap_start_sec"),
            column("overlap_end_sec"),
            column("overlap_sec"),
            column("segment_coverage"),
            column("entity_coverage"),
            column("coverage"),
            column("assigned_word_count"),
        ),
        unique_keys=((column("shot_id"), column("asr_segment_id")),),
        numeric_columns=(column("overlap_start_sec"), column("overlap_end_sec"), column("overlap_sec"), column("segment_coverage"), column("entity_coverage"), column("coverage")),
        integer_columns=(column("assigned_word_count"),),
    ...
    TableSchemaSpec(
        ...
        True,
        (
            column("scene_id"), column("asr_segment_id"), column("video_id"),
            column("overlap_start_sec"), column("overlap_end_sec"),
            column("overlap_sec"), column("segment_coverage"),
            column("entity_coverage"), column("coverage"),
            column("assigned_word_count"),
    ...
    TableSchemaSpec(
        ...
        (
            column("scene_id"),
            column("video_id"),
            column("speech_evidence_status"),
            column("speech_evidence_fingerprint"),
            column("visual_evidence_fingerprint"),
            column("speech_summary_vi"),
            column("speech_summary_en"),
            column("visual_summary_vi"),
            column("visual_summary_en"),
            column("audio_visual_relation"),
            column("summary_vi"),
            column("summary_en"),
            column("provider"),
            column("model_name"),
        ...
        value_columns=(
            ValueRequirement(
                ...
                ("available", "no_speech", "unavailable"),
            ),
            ValueRequirement(
            ...
            ValueRequirement(
                "schema_version",
                ("scene_summary_response_v2",),
            ),
            ValueRequirement(
                "prompt_version",
                ("scene_summary_adaptive_plain_text_v1",),
            ),
        ),
    ),
    TableSchemaSpec(
