...
TABLE_SCHEMA_SPECS: tuple[TableSchemaSpec, ...] = (
    ...
    TableSchemaSpec(
        ...
        True,
        (column("keyframe_id"), column("video_id"), column("frame_id"), column("shot_id"), column("scene_id"), column("keyframe_ref"), column("thumbnail_ref"), column("keyframe_role"), column("is_representative")),
        non_null_columns=(column("keyframe_id"), column("video_id"), column("shot_id"), column("keyframe_role"), column("is_representative")),
        unique_keys=((column("keyframe_id"),),),
        integer_columns=(column("frame_id"),),
        text_columns=(column("keyframe_id"), column("video_id"), column("shot_id"), column("scene_id"), column("keyframe_ref"), column("thumbnail_ref"), column("keyframe_role")),
    ),
    TableSchemaSpec(
        "shots",
