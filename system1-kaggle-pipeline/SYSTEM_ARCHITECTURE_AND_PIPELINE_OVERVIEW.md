...
| **Step 5: Timeline Dedup** | [test_step5_timeline_merge_dedup.py](file:///c:/Nhat_Code/aio/project/AIC/Multimodal-Agentic-Retrieval-Engine/system1-kaggle-pipeline/scripts/steps/test_step5_timeline_merge_dedup.py) | 9/9 test cases: gộp $|\Delta t| \le 0.05\text{s}$, đếm vật thể, bóc tách $\Delta \text{Objects}/\Delta \text{OCR}$, Frame Cắt Nghĩa viền tím, tag BTC-xử lý, chống crash NaN. | **100% PASS** |
| **Step 6: Cultural Lexicon** | [test_step6_cultural_lexicon_and_query.py](file:///c:/Nhat_Code/aio/project/AIC/Multimodal-Agentic-Retrieval-Engine/system1-kaggle-pipeline/scripts/steps/test_step6_cultural_lexicon_and_query.py) | Nhận diện 15+ thực thể văn hóa Việt Nam (có/không dấu), làm giàu truy vấn trung thực (No Hallucination), độ trễ $< 0.5\text{ms}$. | **100% PASS** |
| **1-Click All Step Runner** | [run_all_system1_step_tests.bat](file:///c:/Nhat_Code/aio/project/AIC/Multimodal-Agentic-Retrieval-Engine/run_all_system1_step_tests.bat) | Chạy tự động toàn bộ 6 bước kiểm thử chỉ với 1 click tại Local. | **100% ALL PASS** |
