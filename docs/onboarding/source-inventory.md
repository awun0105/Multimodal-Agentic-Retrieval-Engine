...
Historical onboarding record. Canonical implementation docs now live under `docs/architecture/`, `docs/product/`, `docs/decisions/`, `docs/stories/`, and `docs/validation/`.
...
Do not use archived inputs as source of truth for implementation. Use canonical docs instead.
